            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">About Setup</h4><br><br>
                        ...
                        <form method="post" action="{{ route('update.about') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Resume Link</label>
                                <div class="col-sm-10">
                                    <input id="resume_link" class="form-control" name="resume_link" type="file">
                                </div>
                            </div>
                            <!-- end row -->
