            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Session Status -->
                        <x-auth-session-status class="p-3" :status="session('status')" />
                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('password.update') }}">
                                ...
                                <div class="form-group mb-3">
                                    <div class="col-xs-12">
                                        <input class="form-control" id="email" type="email" name="email" :value="old('email', $request->email)" required="" placeholder="Email">
                                    </div>
                                </div>
