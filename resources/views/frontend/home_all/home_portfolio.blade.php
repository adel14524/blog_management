                                ...
                                <div class="col-lg-6 col-md-10">
                                    <div class="portfolio__inner__thumb">
                                        <a href="{{ route('portfolio.details',$items->id) }}">
                                            <img src="{{ (!empty($items->portfolio_image)) ? url($items->portfolio_image) : url('upload/no_image.jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-10">
                                    <div class="portfolio__inner__content">
                                        <h2 class="title"><a href="{{ route('portfolio.details',$items->id) }}">Ecommerce Product Apps</a></h2>
                                        ...
                                        <a href="{{ route('portfolio.details',$items->id) }}" class="link">View Case Study</a>
                                    </div>
                                </div>
                            </div>
                        </div>
